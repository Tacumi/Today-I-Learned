...
var $author$project$Picshare$errorMessage = function (error) {
	if (error.$ === 'BadBody') {
		return 'Sorry, we couldn\'t process your feed at this time.of\r\n               We\'re working on it!';
	} else {
		return 'Sorry, we couldn\'t load your feed at this time.of\r\n               Please try again later.';
	}
};
...
var $author$project$Picshare$viewCommentsList = function (comments) {
	if (!comments.b) {
...
var $author$project$Picshare$viewComments = function (photo) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Picshare$viewCommentsList(photo.comments),
				A2(
				$elm$html$Html$form,
				_List_fromArray(
					[
